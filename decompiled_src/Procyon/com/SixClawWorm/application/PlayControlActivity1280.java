...
public class PlayControlActivity1280 extends BaseGameActivity
{
        ...
        this.runnable = new Runnable() {
            ...
            public void run() {
                if (!Param.ConntectSucceed && PlayControlActivity1280.this.sencondOnclock == 0) {
                    PlayControlActivity1280.this.startActivity(new Intent((Context)PlayControlActivity1280.this, (Class)NobluetoothActivity.class));
                ...
                PlayControlActivity1280.this.handler.postDelayed((Runnable)this, 10L);
            }
        };
    ...
    private void onKnobDirectionChange(final int n) {
        switch (n) {
            ...
            case -2: {
                ...
                PlayControlActivity1280.up = false;
                PlayControlActivity1280.down = false;
                if (!PlayControlActivity1280.right) {
                    break;
                }
                break;
            }
        ...
        if (this.mChatService != null) {
            if (this.mChatService.getState() == 3) {
                ...
                if (array.length > 0) {
                    this.mChatService.write(array);
                    this.mOutStringBuffer.setLength(0);
                    if ((PlayControlActivity1280.left || PlayControlActivity1280.right || PlayControlActivity1280.blueOnclock || PlayControlActivity1280.yellowOnclock) && (this.stopTime < 500L || GButton.stopTime < 500L) && this.startPauseTime != this.stopTime && !PlayControlActivity1280.redOnclock && !PlayControlActivity1280.blueOnclock && !PlayControlActivity1280.yellowOnclock && !PlayControlActivity1280.greenOnclock) {
    ...
    public Scene onLoadScene() {
        ...
        this.aboutButton = new GButton(1281, 665, this.mCamera, this.mEngine, this.aboutButtonRegion, (GButton.GButtonClickListener)new GButton.GButtonClickListener() {
            @Override
            public void onClick(final AnimatedSprite animatedSprite) {
                PlayControlActivity1280.this.startActivity(new Intent((Context)PlayControlActivity1280.this, (Class)inTrodutionActivity.class));
            }
        ...
        final AnalogOnScreenControl childScene = new AnalogOnScreenControl(140, 160, this.mCamera, this.mOnScreenControlBaseTextureRegion, this.mOnScreenControlKnobTextureRegion, 0.1f, 350L, (AnalogOnScreenControl.IAnalogOnScreenControlListener)new AnalogOnScreenControl.IAnalogOnScreenControlListener() {
            @Override
            public void onControlChange(final BaseOnScreenControl baseOnScreenControl, final float n, final float n2) {
                ...
                if (Math.sqrt(n3 * n3 + n4 * n4) > PlayControlActivity1280.this.RockerCircleR) {
        ...
        this.greenButton = new GButton(875, 125, this.mCamera, this.mEngine, this.greenButtonRegion, (GButton.GButtonClickListener)new GButton.GButtonClickListener() {
            @Override
            public void onClick(final AnimatedSprite animatedSprite) {
                PlayControlActivity1280.greenOnclock = true;
                if (PlayControlActivity1280.yellowOnclock) {
                    PlayControlActivity1280.this.sendMessage(string2Bytes("7100808002800250"));
                }
                else {
                    if (PlayControlActivity1280.blueOnclock) {
                        PlayControlActivity1280.this.sendMessage(string2Bytes("7100808082800260"));
                        return;
                    }
                    if (!PlayControlActivity1280.redOnclock && !PlayControlActivity1280.down && !PlayControlActivity1280.up && !PlayControlActivity1280.left && !PlayControlActivity1280.right && !PlayControlActivity1280.leftDown && !PlayControlActivity1280.leftUp && !PlayControlActivity1280.rightDown && !PlayControlActivity1280.rightUp) {
                        PlayControlActivity1280.this.sendMessage(string2Bytes("7100808080800240"));
                    }
                }
            }
        ...
        this.blueButton = new GButton(1050, 310, this.mCamera, this.mEngine, this.blueButtonRegion, (GButton.GButtonClickListener)new GButton.GButtonClickListener() {
            @Override
            public void onClick(final AnimatedSprite animatedSprite) {
                PlayControlActivity1280.blueOnclock = true;
                if (PlayControlActivity1280.redOnclock) {
                    PlayControlActivity1280.this.sendMessage(string2Bytes("71008080828082A0"));
                }
                    ...
                    PlayControlActivity1280.this.sendMessage(string2Bytes("7100808082808020"));
                }
            }
        ...
        this.redButton = new GButton(700, 305, this.mCamera, this.mEngine, this.redButtonRegion, (GButton.GButtonClickListener)new GButton.GButtonClickListener() {
            @Override
            public void onClick(final AnimatedSprite animatedSprite) {
                PlayControlActivity1280.redOnclock = true;
                if (PlayControlActivity1280.yellowOnclock) {
                    PlayControlActivity1280.this.sendMessage(string2Bytes("7100808002808290"));
                }
                    ...
                    PlayControlActivity1280.this.sendMessage(string2Bytes("7100808080808280"));
                }
            }
        ...
        this.yellowButton = new GButton(875, 470, this.mCamera, this.mEngine, this.yellowButtonRegion, (GButton.GButtonClickListener)new GButton.GButtonClickListener() {
            @Override
            public void onClick(final AnimatedSprite animatedSprite) {
                ...
                if (!PlayControlActivity1280.greenOnclock && !PlayControlActivity1280.blueOnclock && !PlayControlActivity1280.redOnclock && !PlayControlActivity1280.down && !PlayControlActivity1280.up && !PlayControlActivity1280.left && !PlayControlActivity1280.right && !PlayControlActivity1280.leftDown && !PlayControlActivity1280.leftUp && !PlayControlActivity1280.rightDown && !PlayControlActivity1280.rightUp) {
                    PlayControlActivity1280.this.sendMessage(string2Bytes("7100808002808010"));
                }
            }
