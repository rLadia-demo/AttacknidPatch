...
public class CircleOutlineParticleEmitter extends BaseCircleParticleEmitter
{
    ...
    public CircleOutlineParticleEmitter(final float n, final float n2, final float n3, final float n4) {
        super(n, n2, n3, n4);
    }
    ...
    public void getPositionOffset(final float[] array) {
        ...
        array[0] = this.mCenterX + FloatMath.cos(n) * this.mRadiusX;
        array[1] = this.mCenterY + FloatMath.sin(n) * this.mRadiusY;
    }
}
