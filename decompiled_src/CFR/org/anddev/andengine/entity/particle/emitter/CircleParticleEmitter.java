...
extends BaseCircleParticleEmitter {
    ...
    public void getPositionOffset(float[] arrf) {
        ...
        arrf[0] = this.mCenterX + FloatMath.cos((float)f) * this.mRadiusX * MathUtils.RANDOM.nextFloat();
        arrf[1] = this.mCenterY + FloatMath.sin((float)f) * this.mRadiusY * MathUtils.RANDOM.nextFloat();
    }
}
