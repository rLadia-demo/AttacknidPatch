  ...
  extends BaseGameActivity
{
  ...
  Runnable runnable = new Runnable()
  {
    public void run()
    {
      ...
      {
        Intent localIntent = new Intent(PlayControlActivity1280.this, NobluetoothActivity.class);
        PlayControlActivity1280.this.startActivity(localIntent);
      ...
      PlayControlActivity1280.this.handler.postDelayed(this, 10L);
    }
  };
  ...
  private void sendMessage(byte[] paramArrayOfByte)
  {
    ...
    new Thread()
    {
      public void run()
      {
        for (;;)
        {
          if (PlayControlActivity1280.this.stopThread) {
            return;
          }
          try
          {
  ...
  public void onLoadResources()
  {
    ...
    this.mBackgroundTextureRegion = TextureRegionFactory.createFromAsset(this.mTexture, this, "background-1280.jpg", 0, 0);
    this.singalSpriteRegion = TextureRegionFactory.createTiledFromAsset(this.mTexture, this, "signal.png", 0, 1150, 4, 1);
    this.backButtonRegion = TextureRegionFactory.createTiledFromAsset(this.mTexture, this, "btn_back1280.png", this.CAMERA_WIDTH, 0, 2, 1);
    this.aboutButtonRegion = TextureRegionFactory.createTiledFromAsset(this.mTexture, this, "btn_about1280.png", this.CAMERA_WIDTH, 1281, 2, 1);
    this.mOnScreenControlTexture = new Texture(1024, 1024, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
    this.mOnScreenControlBaseTextureRegion = TextureRegionFactory.createFromAsset(this.mOnScreenControlTexture, this, "control_base1280.png", 120, 120);
    this.mOnScreenControlKnobTextureRegion = TextureRegionFactory.createFromAsset(this.mOnScreenControlTexture, this, "control_knob1280.png", 550, 0);
    this.mControlButtonTexture = new Texture(1024, 512, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
    this.greenButtonRegion = TextureRegionFactory.createTiledFromAsset(this.mControlButtonTexture, this, "btn_green1280.png", 0, 0, 2, 1);
    this.redButtonRegion = TextureRegionFactory.createTiledFromAsset(this.mControlButtonTexture, this, "btn_red1280.png", 280, 0, 2, 1);
    this.blueButtonRegion = TextureRegionFactory.createTiledFromAsset(this.mControlButtonTexture, this, "btn_blue1280.png", 0, 140, 2, 1);
    this.yellowButtonRegion = TextureRegionFactory.createTiledFromAsset(this.mControlButtonTexture, this, "btn_yellow1280.png", 280, 140, 2, 1);
  ...
  public Scene onLoadScene()
  {
    ...
    this.aboutButton = new GButton(1281, 665, this.mCamera, this.mEngine, this.aboutButtonRegion, new GButton.GButtonClickListener()
    {
      public void onClick(AnimatedSprite paramAnonymousAnimatedSprite)
      {
        Intent localIntent = new Intent(PlayControlActivity1280.this, inTrodutionActivity.class);
        PlayControlActivity1280.this.startActivity(localIntent);
      }
    ...
    AnalogOnScreenControl localAnalogOnScreenControl = new AnalogOnScreenControl(140, 160, this.mCamera, this.mOnScreenControlBaseTextureRegion, this.mOnScreenControlKnobTextureRegion, 0.1F, 350L, new AnalogOnScreenControl.IAnalogOnScreenControlListener()
    {
      public void onControlChange(BaseOnScreenControl paramAnonymousBaseOnScreenControl, float paramAnonymousFloat1, float paramAnonymousFloat2)
      {
        ...
        double d;
        if (Math.sqrt(f1 * f1 + f2 * f2) > PlayControlActivity1280.this.RockerCircleR)
        {
    ...
    this.greenButton = new GButton(875, 125, this.mCamera, this.mEngine, this.greenButtonRegion, new GButton.GButtonClickListener()
    {
      public void onClick(AnimatedSprite paramAnonymousAnimatedSprite)
      {
        ...
        {
          byte[] arrayOfByte3 = PlayControlActivity1280.string2Bytes("7100808002800250");
          PlayControlActivity1280.this.sendMessage(arrayOfByte3);
        }
        do
        {
          return;
          ...
          {
            byte[] arrayOfByte2 = PlayControlActivity1280.string2Bytes("7100808082800260");
            PlayControlActivity1280.this.sendMessage(arrayOfByte2);
            return;
          }
        } while ((PlayControlActivity1280.redOnclock) || (PlayControlActivity1280.down) || (PlayControlActivity1280.up) || (PlayControlActivity1280.left) || (PlayControlActivity1280.right) || (PlayControlActivity1280.leftDown) || (PlayControlActivity1280.leftUp) || (PlayControlActivity1280.rightDown) || (PlayControlActivity1280.rightUp));
        byte[] arrayOfByte1 = PlayControlActivity1280.string2Bytes("7100808080800240");
        PlayControlActivity1280.this.sendMessage(arrayOfByte1);
      }
    ...
    this.blueButton = new GButton(1050, 310, this.mCamera, this.mEngine, this.blueButtonRegion, new GButton.GButtonClickListener()
    {
      public void onClick(AnimatedSprite paramAnonymousAnimatedSprite)
      {
        ...
        {
          arrayOfByte2 = PlayControlActivity1280.string2Bytes("71008080828082A0");
          PlayControlActivity1280.this.sendMessage(arrayOfByte2);
        }
        while ((PlayControlActivity1280.greenOnclock) || (PlayControlActivity1280.yellowOnclock) || (PlayControlActivity1280.down) || (PlayControlActivity1280.up) || (PlayControlActivity1280.left) || (PlayControlActivity1280.right) || (PlayControlActivity1280.leftDown) || (PlayControlActivity1280.leftUp) || (PlayControlActivity1280.rightDown) || (PlayControlActivity1280.rightUp))
        {
          byte[] arrayOfByte2;
          return;
        }
        byte[] arrayOfByte1 = PlayControlActivity1280.string2Bytes("7100808082808020");
        PlayControlActivity1280.this.sendMessage(arrayOfByte1);
      }
    ...
    this.redButton = new GButton(700, 305, this.mCamera, this.mEngine, this.redButtonRegion, new GButton.GButtonClickListener()
    {
      public void onClick(AnimatedSprite paramAnonymousAnimatedSprite)
      {
        ...
        if (PlayControlActivity1280.yellowOnclock)
        {
          arrayOfByte2 = PlayControlActivity1280.string2Bytes("7100808002808290");
          PlayControlActivity1280.this.sendMessage(arrayOfByte2);
        }
        while ((PlayControlActivity1280.blueOnclock) || (PlayControlActivity1280.greenOnclock) || (PlayControlActivity1280.down) || (PlayControlActivity1280.up) || (PlayControlActivity1280.left) || (PlayControlActivity1280.right) || (PlayControlActivity1280.leftDown) || (PlayControlActivity1280.leftUp) || (PlayControlActivity1280.rightDown) || (PlayControlActivity1280.rightUp))
        {
          byte[] arrayOfByte2;
          return;
        }
        byte[] arrayOfByte1 = PlayControlActivity1280.string2Bytes("7100808080808280");
        PlayControlActivity1280.this.sendMessage(arrayOfByte1);
      }
    ...
    this.yellowButton = new GButton(875, 470, this.mCamera, this.mEngine, this.yellowButtonRegion, new GButton.GButtonClickListener()
    {
      public void onClick(AnimatedSprite paramAnonymousAnimatedSprite)
      {
        ...
        {
          byte[] arrayOfByte = PlayControlActivity1280.string2Bytes("7100808002808010");
          PlayControlActivity1280.this.sendMessage(arrayOfByte);
        }
      }
 ...
 * Qualified Name:     com.SixClawWorm.application.PlayControlActivity1280
